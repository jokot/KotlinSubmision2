...
import com.example.jokot.footballclub.activity.DetailActivity
import com.example.jokot.footballclub.adapter.MainAdapter
import com.example.jokot.footballclub.api.ApiRepository
import com.example.jokot.footballclub.model.Match
import com.example.jokot.footballclub.presenter.MainPresenter
            ...
            swipeRefresh = swipeRefreshLayout {
                ...
                relativeLayout {
                    ...
                    listTeam = recyclerView {
                        id = R.id.list_prev_match
                        lparams(width = matchParent, height = wrapContent)
                        layoutManager = LinearLayoutManager(ctx)
                    }

                    progressBar = progressBar {
                        id = R.id.progress_bar_prev
                    }.lparams {
                        centerHorizontally()
                    }
                }
